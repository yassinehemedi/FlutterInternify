...
import 'package:internify/models/internship_demand.dart';
...
<html>
  <body style="font-family: Arial, sans-serif; color:#333;">
    ...
    <h3 style="color:#0066CC;">$newStatus</h3>
    <hr/>
    ...
    ${feedback != null ? '<div style="background:#f8f9fa;padding:12px;border-left:4px solid #0066CC;margin-top:12px;"><strong>Feedback:</strong><div>$feedback</div></div>' : ''}
    <p style="margin-top:20px;">Regards,<br/>Internify Team</p>
  </body>
</html>
''';
